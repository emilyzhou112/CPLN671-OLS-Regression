...
bachelor's degree,educational level plays crucial rule in an area's housing value, 
vacant rate: vacant housing
detached single family housing's ratio affects the area's housing typology, 

Research also consistently demonstrates a strong correlation between poverty levels and housing values. Areas with higher poverty rates often experience reduced demand for housing, as well as diminished investment in local infrastructure and services, which in turn can lead to lower property values 
