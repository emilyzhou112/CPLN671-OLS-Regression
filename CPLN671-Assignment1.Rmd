...
b)  Present either a brief review of the literature (use Google Scholar) or simply speculate as to why the predictors we are using might be related with the response variable.
